...
func TestInitProject_CreatesFiles(t *testing.T) {
	...
	for _, file := range []string{"docs/IDENTITY.md", "docs/PERSONALITY.md", "docs/JOURNAL.md", "DAY_COUNT"} {
...
func TestInitProject_IDENTITYContent(t *testing.T) {
	...
	data, _ := os.ReadFile(filepath.Join(dir, "docs/IDENTITY.md"))
